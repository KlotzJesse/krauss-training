    ...
    <section class="text-gray-700 flex-grow flex flex-col xl:flex-row xl:space-x-32 space-y-5 md:space-y-0 mx-auto items-center justify-center xl:py-0 py-28">
      <div class="flex-initial w-2/3 flex flex-col items-center justify-center animate-fadein">
        ...
        <p class="text-2xl text-gray-500 font-normal mb-8">
          Ich helfe Führungskräfte, Verkäufer & Online-Marketing Manager dabei,
          ihre Potenziale zu erkennen und Chancen in Ihrem Unternehmen zu
          ergreifen, um zu höchstleistungen zu gelangen.
        </p>

        <button class="self-start xl:flex hidden text-white bg-indigo-500 shadow-lg hover:shadow-inner transition duration-500 ease-in-out transform hover:-translate-y-1 uppercase hover:scale-110 border-0 focus:outline-none hover:bg-indigo-600 text-lg text-teal-500 rounded-lg font-medium py-4 px-12 mr-2 items-center hover:bg-teal-500 hover:text-white">
      ...
      <div class="flex-initial xl:self-end w-1/2 flex items-center justify-center flex-col">
        <img
          src="https://i.ibb.co/FKwsqfx/johannes-krauss-1.png"
          alt="Johannes Krauss"
        />
